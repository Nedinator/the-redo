...
export default {
    ...
    async execute(interaction) {
        ...
        const whom = interaction.guild?.members.cache.get(who?.id || "No ID found?");
        if (!whom)
        ...
        if (whom && why) {
            ...
            await interaction.reply({
                content: "You broke me! Why is there no user? Oh, I guess they might not be cached if they're new",
                ephemeral: true,
            });
        }
    },
